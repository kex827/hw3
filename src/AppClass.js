...
class App extends Component {
  ...
  render() {
    ...
    let cards = [];
    let card1Image = "http://golearntocode.com/images/cards/8_of_diamonds.png";
    let card2Image = "http://golearntocode.com/images/cards/8_of_diamonds.png";
    let card3Image = "http://golearntocode.com/images/cards/8_of_diamonds.png";
    let card4Image = "http://golearntocode.com/images/cards/8_of_diamonds.png";
    let card5Image = "http://golearntocode.com/images/cards/8_of_diamonds.png";
    return (
      <div className="App">
        {cards}
        <img src={card1Image} />
